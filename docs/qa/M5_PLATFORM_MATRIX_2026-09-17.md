...
| GitHub Actions `m5-platform-matrix.yml` (Windows, Linux server/sandbox, Linux desktop-native, web) | Intended to upload named lists and raw logs per head SHA | [PR #51 run 35297498359](https://github.com/black-candle-technologies/lumen/actions/runs/35297498359) failed before any job step started; no artifacts | BLOCKED by account payments/spending limit, not a test result |
